                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{url('/test/detail/'.$item->id) }}" style="white-space:unset;text-align: justify;"> {{$item->name}} <i class="fa fa-edit"></i></a></td>
